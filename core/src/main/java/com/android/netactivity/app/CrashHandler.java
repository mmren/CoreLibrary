...
public class CrashHandler implements UncaughtExceptionHandler
{
     ...
     */
    private ACache mDeviceCrashInfo = null;
     ...
     * @param ctx
     */
    public void init(CoreApplication ctx)
    {
        mContext = ctx;
        mDefaultHandler = Thread.getDefaultUncaughtExceptionHandler();
        Thread.setDefaultUncaughtExceptionHandler(this);
        mDeviceCrashInfo = ACache.get(mContext);
    }
    ...
    public void uncaughtException(Thread thread, Throwable ex)
    {
        ...
        CoreApplication maiyaApplication = CoreApplication.getInstance();
        if (maiyaApplication != null)
        {
            maiyaApplication.unregisterWindowUtil();
        }
...
//            {
//                Looper.prepare();
//                Toast toast = Toast.makeText(mContext, "程序出错，即将退出:\r\n" + (StringUtils.isEmpty(msg) ? "" : msg), Toast.LENGTH_LONG);
...
//        }.start();
     ...
     * @return
     */
    private String saveCrashInfoToFile(@NonNull Throwable ex)
    {
        try
        {
